...
// Determine routes to pre-render from src/routes.
// For examples sake, we'll pre-render all the routes inside of `routes` directory, since they technically all static (not fetching data from an external source like an API etc)
const routesToPrerender = fs
  .readdirSync(getAbsolutePath('src/routes'))
  .map((file) => {
